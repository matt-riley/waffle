---
title: "Deploying and running Waffle"
description: "Managed host installation, service units, health, GitHub App setup, and workspace egress."
sidebar:
  order: 7
---
...
[Chat](/docs/under-the-hood/chat-clients/) for the TUI, connection precedence, commands, security
...
See the [Waffle Desk rollout guide](/docs/under-the-hood/waffle-desk/) for access boundaries,
