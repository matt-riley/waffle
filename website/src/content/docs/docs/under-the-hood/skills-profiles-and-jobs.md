---
title: "Skills, profiles, subagents, and scheduled jobs"
description: "Using the four features that shape day-to-day work: skills, agent profiles, subagents, and cron."
sidebar:
  order: 3
---
...
in [chat.md](/docs/under-the-hood/chat-clients/). The front door is [README.md](https://github.com/matt-riley/waffle/blob/main/README.md).
...
See the [Waffle Desk rollout guide](/docs/under-the-hood/waffle-desk/) for enablement, access,
