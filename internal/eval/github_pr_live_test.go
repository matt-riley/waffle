...
func TestParsePRResult(t *testing.T) {
	cases := []struct {
		...
		{name: "enterprise host", out: "Opened pull request #12 for owner/repo: https://github.example.com/owner/repo/pull/12", number: 12, htmlURL: "https://github.example.com/owner/repo/pull/12"},
		{name: "trailing noise", out: "Opened pull request #3 for owner/repo: https://github.com/owner/repo/pull/3\n", number: 3, htmlURL: "https://github.com/owner/repo/pull/3"},
