...
type Server struct {
	...
	// build (#393). Only native codeintel servers set it (via the #79
	// heuristics): plugin-sourced servers are always optional, enforced by
	// the agent-build plugin wiring path (wirePluginMCPServer), not by this
	// flag (#402 review).
	Optional bool
