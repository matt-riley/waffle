...
func TestSharedDTOsUseStableJSONFieldNames(t *testing.T) {
	...
	values := []struct {
		...
		{Event{Kind: EventNotice, Text: "text", ToolName: "tool", ToolCallID: "call-1", IsError: true, ByteCount: 2, DurationMS: 3, Usage: llm.Usage{InputTokens: 1}, State: &State{SessionID: "s"}, Artifacts: []Artifact{{ID: "art-1", Name: "a.md"}}}, []string{"kind", "text", "tool_name", "tool_call_id", "is_error", "byte_count", "duration_ms", "usage", "state", "artifacts"}},
